...
public class ICICIBankCard implements ATMCard {
	...
	static {
		System.out.println("ICICIBankCard is loaded");
	}

	public ICICIBankCard(long accNum, String acchNum, double balance) {
		this.accNum = accNum;
		this.acchNum = acchNum;
		this.balance = balance;
		System.out.println("ICICIBankCard object is created");
	}
	...
	public String deposit(double amt) throws NegativeAmountException {
		...
		return amt + " is credited to "+ accNum + "\n avalible balance in ICICIBankCard is " +balance;
	}
	...
	public void currentBalance() {
		System.out.println("Current balance in ICICIBankCard is" +balance);

	}

	@Override
	public String toString() {
		return "ICICIBankCard [accNum=" + accNum + ", acchNum=" + acchNum + ", balance=" + balance + "]";
	}
